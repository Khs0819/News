                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('website.newsdetailes', $article->id) }}" class="btn btn-primary">Learn
                                    More</a>
                            </div>
                        </div>
                    </div>
    ...
    @foreach ($categories as $category)
        <section class="gray-sec">
            <div class="container">
                        ...
                        <div class="col-lg-4 col-sm-6 portfolio-item">
                            <div class="card h-100">
                                <a href="#"><img class="card-img-top"
                                        src="{{ asset('storage/images/article/' . $article->image) }}" alt=""></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                ...
                <div align="center"><a class="btn btn-success" href="{{ route('website.all', $category->id) }}">more
                        news</a></div>
            </div>
        </section>
    @endforeach
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid rounded full-width" src="{{ asset('website/img/6.jpeg') }}" alt=""
                        style="">
                </div>
            </div>
            <!-- /.row -->
