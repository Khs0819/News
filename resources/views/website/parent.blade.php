...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="{{ route('website.index') }}">news</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('website.all',$category->id) }}">{{ Illuminate\Support\Str::lower($category->name)}}</a>
                    </li>
                    @endforeach
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white"><a type="button" href="{{ route('button_users') }}">Copyright</a>
                &copy; Momen Sisalem 2018</p>
        </div>
        <!-- /.container -->
    </footer>
