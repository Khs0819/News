    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">الأخبار</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item  has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p>المتحكمين<i class="fas fa-angle-left right"></i></p>
                            </a>
                        ...
                        <li class="nav-item  has-treeview">
                            <a href="#" class="nav-link">
                                <i class="nav-icon far fa-user"></i>
                                {{-- <i class="far fa-user"></i> --}}
                                <p>الناشرين<i class="fas fa-angle-left right"></i></p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                <i class="fa-solid fa-newspaper"></i>                                <p>
                                    المقالات
                                    <i class="fas fa-angle-left right"></i>
                                </p>
                            </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> @yield('main_title')</h1>
                        </div><!-- /.col -->
