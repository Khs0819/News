                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name"
                                            value="{{ $admins->user->first_name }}" placeholder="أدخل الاسم الأول">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="last_name">الأسم الاخير</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name"
                                            value="{{ $admins->user->last_name }}" placeholder="أدخل الاسم الأخير">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2" id="city_id" name="city_id"
                                            style="width: 100%;">
                                            <option selected value="{{ $admins->user->city->id }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="mobile" name="mobile"
                                            value="{{ $admins->user->mobile }}" placeholder="أدخل رقم الهاتف">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="address">العنوان</label>
                                        <input type="text" class="form-control" id="address" name="address"
                                            value="{{ $admins->user->address }}" placeholder="أدخل العنوان">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="date" name="date"
                                            value="{{ $admins->user->date }}" placeholder="أدخل تاريخ الميلاد">
                                    </div>
